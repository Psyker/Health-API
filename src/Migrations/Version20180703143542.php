 ...
 */
final class Version20180703143542 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE psychologist (id INT AUTO_INCREMENT NOT NULL, specialization_id INT DEFAULT NULL, firstname VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, lastname VARCHAR(500) NOT NULL COLLATE utf8mb4_unicode_ci, gender TINYINT(1) NOT NULL, age INT NOT NULL, INDEX IDX_FFC468E0FA846217 (specialization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
